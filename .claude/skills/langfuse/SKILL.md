...
Covers the common Langfuse workflows: instrumenting applications, migrating prompts, debugging traces, and accessing data programmatically.
...
3. **Use latest Langfuse versions**: Use the latest SDK/API version unless the user specified one or the project pins one (check the README, lockfile, or .env).


## Use case specific references

- instrumenting an existing function/application (the workshop's S3 OBSERVE step): references/instrumentation.md
- anything else: fetch the current docs per section 2 below
